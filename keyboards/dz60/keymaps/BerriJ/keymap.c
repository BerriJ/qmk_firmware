...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LCTRL, KC_LGUI, KC_LALT, KC_NO, KC_SPC, KC_NO, KC_NO, KC_RALT, KC_NO, KC_AUDIO_MUTE, KC_RCTRL),

	LAYOUT(
		KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_AUDIO_VOL_UP,
		RESET, LSFT(KC_9), RALT(KC_9), RALT(KC_0), LCA(KC_R), KC_TRNS, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, PIPE, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, LSFT(KC_8), RALT(KC_8), RALT(KC_7), LCTL(KC_F), KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END, KC_TRNS, KC_TRNS, KC_MEDIA_PLAY_PAUSE,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_AUDIO_VOL_DOWN, KC_NO,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MEH(KC_C), KC_TRNS, KC_TRNS, KC_MEDIA_PREV_TRACK, KC_NO, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK),

	LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RALT(KC_8), RALT(KC_8), RALT(KC_8), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDOWN, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
